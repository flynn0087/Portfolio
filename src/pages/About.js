...
function About() {
  return (
    <div style={{ backgroundImage: `url(${ImageMtn})`, backgroundSize: `cover` }}>
      <Container>
        <Row>
          <Col size="xl-12">
        ...
        <Row class="fill">
          <Col size="xl-3">
            ...
            <ul style={{backgroundColor: "white"}}>
              ...
              <li style={{fontWeight: "bold"}}><a href="https://github.com/flynn0087" target="_blank" rel="noopener noreferrer">Github</a></li>
              <li style={{fontWeight: "bold"}}><a href="https://www.linkedin.com/in/benjamin-flynn-83953942/" target="_blank" rel="noopener noreferrer">My LinkedIn</a></li>
            </ul>
          </Col>
        </Row>
      </Container>
